...
public class ShiftRegisterTest {
    ...
    @Test
    public void testError() {
        ILFShiftRegister r = getRegister(8, 1);
        int[] seed = {1, 0, 0, 0, 1, 1, 0};
        r.setSeed(seed);
        r.shift();
        r.generate(4);
    ...
    //I think the setSeed(int[] seed) method could throw an exception if the length of seed differs from the seed taken in as the argument.
}
